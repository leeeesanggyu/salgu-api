package com.salgu.salguapi.util;
...
public class AopLogger {
    ...
    @Pointcut("within(com.salgu.salguapi.*.controller..*)") // 3
    public void onRequest() {
    }

    @Pointcut("within(com.salgu.salguapi.util.exception.GlobalExceptionHandler)") // 3
    public void onErrorRequest() {
    }

    @Around("com.salgu.salguapi.util.AopLogger.onRequest() || com.salgu.salguapi.util.AopLogger.onErrorRequest()") // 4
